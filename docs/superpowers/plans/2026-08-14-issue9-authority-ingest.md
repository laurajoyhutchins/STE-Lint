...
- Source discrepancies are reported, not silently normalized.
...
### Task 4: Structure Part 2 dictionary
...
- [x] Classify approved headwords from the source's uppercase convention.
- [x] Report the 875-versus-877 cardinality discrepancy without coercion.
...
- [x] Record counts and validation results in `manifest.json`.
- [x] Package the private authority bundle separately from the public repository.

### Task 6: Document the maintenance boundary
